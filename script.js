...
form.addEventListener('submit', async (e) => {
    ...
    try {
        ...
        for (const [key, value] of formData.entries()) {
            // Skip file inputs (handled separately if needed)
        ...
        // 3. Paste the doPost() code from the setup guide
        ...
        if (GOOGLE_SHEETS_URL !== 'PASTE_YOUR_GOOGLE_APPS_SCRIPT_URL_HERE') {
            ...
            // DEMO MODE — No URL set yet, simulate a short delay
            console.log('⚠️ Demo mode: Set GOOGLE_SHEETS_URL to send data to Google Sheets.');
